...
# This call will perform capability detection on startup.
...
async def api_command():
    ...
    try:
        ...
        selection = payload.get("selection", []) # List of object IDs
...
@app.route('/api/tessellate', methods=['GET'])
...
async def api_import():
    ...
    try:
        ...
        filename = str(uuid.uuid4()) # Secure filename
...
if __name__ == '__main__':
    # Note: For production, use a real ASGI server like Hypercorn
